...
//					out.write(Text.toString() + "_$_" + event.subtype);
		...
		//@AureDI  Write the text to the file without tokenization.
//		for (int i = 0; i < zones.size(); i++) {
//			int start = ((Annotation) zones.get(i)).span().start();
//			int end = ((Annotation) zones.get(i)).span().end();
//			while(doc.text().charAt(end-1) == '\n' || doc.text().charAt(end-1) == ' ')
//				end--;
//			try {		
...
//	        		}
//				}
//				out.write(Text.toString() + "_$_NoEvent" + "\r\n");
//			}catch (IOException e) {
//				// TODO Auto-generated catch block
//				e.printStackTrace();
//			}
